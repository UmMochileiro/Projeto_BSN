...
function getInheritedInjectableDef(type) {
  var _a4;
  const def = (_a4 = type == null ? void 0 : type[NG_PROV_DEF]) != null ? _a4 : null;
  if (def) {
...
function signal(initialValue, options) {
  const [get2, set2, update] = createSignal(initialValue, options == null ? void 0 : options.equal);
  const signalFn = get2;
...
function setDirectiveInput(tNode, tView, lView, target, publicName, value) {
  ...
  let hasSet = false;
  if (ngDevMode && !((_a4 = tNode.directiveToIndex) == null ? void 0 : _a4.has(target.type))) {
...
var ViewRef = class {
  ...
  checkNoChanges() {
    ...
    if (!ngDevMode)
      return;
    try {
      (_a4 = this.exhaustive) != null ? _a4 : this.exhaustive = this._lView[INJECTOR].get(UseExhaustiveCheckNoChanges, USE_EXHAUSTIVE_CHECK_NO_CHANGES_DEFAULT);
    } catch {
...
function cleanupMatchingDehydratedViews(hostLView, currentTNode) {
  var _a4;
  const ssrId = (_a4 = currentTNode.tView) == null ? void 0 : _a4.ssrId;
  if (ssrId == null)
    return false;
...
function createLQuery(tView, lView, flags) {
  ...
  const lQueries = ((_b2 = lView[_a4 = QUERIES]) != null ? _b2 : lView[_a4] = new LQueries_()).queries;
...
function performanceMarkFeature(feature) {
  ...
  (_a4 = performance == null ? void 0 : performance.mark) == null ? void 0 : _a4.call(performance, "mark_feature_usage", { detail: { feature } });
}
...
function locateOrCreateContainerAnchorImpl(tView, lView, tNode, index) {
  ...
  const ssrId = (_b2 = (_a4 = hydrationInfo == null ? void 0 : hydrationInfo.data[TEMPLATES]) == null ? void 0 : _a4[index]) != null ? _b2 : null;
...
var EventEmitter_ = class extends Subject {
  ...
  constructor(isAsync = false) {
    ...
    if (isInInjectionContext()) {
      this.destroyRef = (_a4 = inject(DestroyRef, { optional: true })) != null ? _a4 : void 0;
      this.pendingTasks = (_b2 = inject(PendingTasksInternal, { optional: true })) != null ? _b2 : void 0;
    }
  }
  emit(value) {
    const prevConsumer = setActiveConsumer(null);
...
var _AfterRenderImpl = class _AfterRenderImpl {
  ...
  register(sequence) {
    ...
    const { view } = sequence;
    if (view !== void 0) {
      ((_b2 = view[_a4 = AFTER_RENDER_SEQUENCES_TO_ADD]) != null ? _b2 : view[_a4] = []).push(sequence);
...
function getInjectorMetadata(injector) {
  ...
  if (injector instanceof R3Injector) {
    return { type: "environment", source: (_a4 = injector.source) != null ? _a4 : null };
  }
...
function getTemplateConsumer(injector) {
  ...
  if (isLView(templateLView)) {
    return (_a4 = templateLView[REACTIVE_TEMPLATE_CONSUMER]) != null ? _a4 : null;
  }
  return null;
}
...
var _Testability = class _Testability {
  ...
  constructor(_ngZone, registry, testabilityGetter) {
    ...
    if (isInInjectionContext()) {
      this._destroyRef = (_a4 = inject(DestroyRef, { optional: true })) != null ? _a4 : void 0;
    }
...
var _ApplicationInitStatus = class _ApplicationInitStatus {
  ...
  appInits = (_a2 = inject(APP_INITIALIZER, { optional: true })) != null ? _a2 : [];
...
function executeWithInvalidateFallback(importMeta, id, callback) {
  ...
  try {
    ...
    if (id !== null && error.message) {
      ...
      (_b2 = (_a4 = importMeta == null ? void 0 : importMeta.hot) == null ? void 0 : _a4.send) == null ? void 0 : _b2.call(_a4, "angular:invalidate", { id, message: toLog, error: true });
    }
    throw e;
  }
}
...
function directiveMetadata(type, metadata) {
  ...
  return {
    ...
    hostDirectives: ((_a4 = metadata.hostDirectives) == null ? void 0 : _a4.map((directive) => typeof directive === "function" ? { directive } : directive)) || null
  };
}
...
var _ChangeDetectionSchedulerImpl = class _ChangeDetectionSchedulerImpl {
  ...
  disableScheduling = (_a3 = inject(ZONELESS_SCHEDULER_DISABLED, { optional: true })) != null ? _a3 : false;
  ...
  scheduleInRootZone = !this.zonelessEnabled && this.zoneIsDefined && ((_c = inject(SCHEDULE_IN_ROOT_ZONE, { optional: true })) != null ? _c : false);
...
function createViewEffect(view, notifier, fn) {
  ...
  node.fn = fn;
  (_b2 = view[_a4 = EFFECTS]) != null ? _b2 : view[_a4] = /* @__PURE__ */ new Set();
...
function resource(options) {
  ...
  const params = (_b2 = (_a4 = options.params) != null ? _a4 : oldNameForParams) != null ? _b2 : () => null;
  return new ResourceImpl(params, getLoader(options), options.defaultValue, options.equal ? wrapEqualityFn(options.equal) : void 0, (_c2 = options.injector) != null ? _c2 : inject(Injector), RESOURCE_VALUE_THROWS_ERRORS_DEFAULT);
}
    ...
    if (win) {
      ...
      const setup = () => {
        ...
        if (doc.readyState === "complete") {
          ...
          (_a5 = this.window) == null ? void 0 : _a5.addEventListener("load", waitToScan, { once: true });
        }
      };
      if (typeof Zone !== "undefined") {
        Zone.root.run(() => setup());
...
function serializeLContainer(lContainer, tNode, lView, parentDeferBlockId, context) {
  ...
  for (let i = CONTAINER_HEADER_OFFSET; i < lContainer.length; i++) {
    ...
    if (views.length > 0 && currentViewAsString === lastViewAsString) {
      ...
      (_b2 = previousView[_a4 = MULTIPLIER]) != null ? _b2 : previousView[_a4] = 1;
...
function appendSerializedNodePath(ngh, tNode, lView, excludedParentNodes) {
  var _a4, _b2, _c2, _d;
  const noOffsetIndex = tNode.index - HEADER_OFFSET;
  (_b2 = ngh[_a4 = NODES]) != null ? _b2 : ngh[_a4] = {};
  (_d = (_c2 = ngh[NODES])[noOffsetIndex]) != null ? _d : _c2[noOffsetIndex] = calcPathForNode(tNode, lView, excludedParentNodes);
}
function appendDisconnectedNodeIndex(ngh, tNodeOrNoOffsetIndex) {
  ...
  (_b2 = ngh[_a4 = DISCONNECTED_NODES]) != null ? _b2 : ngh[_a4] = [];
...
function serializeLView(lView, parentDeferBlockId = null, context) {
  ...
  for (let i = HEADER_OFFSET; i < tView.bindingStartIndex; i++) {
    ...
    if (i18nData) {
      (_b2 = ngh[_a4 = I18N_DATA]) != null ? _b2 : ngh[_a4] = {};
    ...
    if (isLContainer(lView[i]) && tNode.tView) {
      (_d = ngh[_c2 = TEMPLATES]) != null ? _d : ngh[_c2] = {};
    ...
    if (isLContainer(lView[i])) {
      ...
      (_f = ngh[_e = CONTAINERS]) != null ? _f : ngh[_e] = {};
      ...
      if (tNode.type & 8) {
        (_h = ngh[_g = ELEMENT_CONTAINERS]) != null ? _h : ngh[_g] = {};
...
@angular/core/fesm2022/debug_node-DTOmNMDH.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-OIZZFRBO.js.map
